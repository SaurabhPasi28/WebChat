            ...
            {filteredUsers.map((user) => {
              ...
              return (
                <div
                  key={user._id}
                  className={`
                    p-4 flex items-center hover:bg-gray-50 transition-colors cursor-pointer
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between mt-1">
                      ...
                      {/* Unread Count */}
                      {unreadCount > 0 && (
                        <span className="ml-2 bg-indigo-600 text-white text-xs font-medium h-5 w-5 flex items-center justify-center rounded-full min-w-[20px]">
